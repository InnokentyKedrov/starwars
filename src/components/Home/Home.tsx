      ...
      <section className={styles.home__container}>
        <div className={styles.home__title_wrapper}>
          ...
          <div className={styles.home__title_description_wrapper}>
            <p className={styles.home__title_description}>{textData.home.description1[language]}</p>
            <p className={styles.home__title_description}>{textData.home.description2[language]}</p>
            <p className={styles.home__title_description}>{textData.home.description3[language]}</p>
          </div>
          {width > 1046 && <Button />}
        </div>
